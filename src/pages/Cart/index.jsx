      ...
      <div className="container mx-auto mt-10">
        <div className="flex shadow-md my-10">
          <div className="w-3/4 bg-white px-10 py-10">
                    ...
                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                      <div className="flex w-2/5">
                        ...
                        <div className="flex flex-col justify-between ml-4 flex-grow">
                          <span className="font-bold text-sm">{item?.category
                          }</span>
                          <span className="text-red-500 text-xs">{item?.title}</span>
                          <a href="#" className="font-semibold hover:text-red-500 text-gray-500 text-xs" onClick={() => removeProduct(item.id)}>Remove</a>
                        </div>
                      </div>
            ...
            <Link to="/products" className="flex font-semibold text-yellow-600 text-sm mt-10">
          ...
          <div id="summary" className="w-1/4 px-8 py-10">
            ...
            <button className="bg-yellow-500 hover:bg-yellow-600 px-5 py-2 text-sm text-white uppercase">Apply</button>
