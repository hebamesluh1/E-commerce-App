        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt={product?.title} className="lg:w-1/2 w-full lg:h-auto h-64 object-contain object-center rounded max-h-[400px]" src={product?.image} />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className='flex '>
                                <button className="flex ml-auto text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded mr-2">By it Now</button>
                                <button className="flex ml-auto text-yellow bg-white-500 border border-yellow-500 py-2 px-6 focus:outline-none hover:bg-yellow-500 hover:text-white rounded">Add to cart</button>
                            </div>
